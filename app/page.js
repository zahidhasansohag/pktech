        ...
        {activeTab === 'billing' && (
          <>
            ...
            <div className="w-full md:w-auto flex justify-center print:border-none print:p-0 print:m-0 print:block">
              <div id="printable-receipt" className="bg-white text-black p-6 w-[80mm] mx-auto border border-gray-300">
               <div className="text-center mb-4 border-b border-gray-400 pb-2">
                 <div className="text-3xl font-black">PK TECH</div>
                 <p className="text-sm font-bold">Khidirpur Bazar</p>
                 <p className="text-xs">Hotline: +880 1575-823886</p>
               </div>
               ...
               <p className="text-xl font-bold mt-4 text-right border-t border-gray-400 pt-2">TOTAL: ৳{totalAmount.toFixed(2)}</p>

               {/* TERMS AND CONDITIONS SECTION ADDED HERE */}
               <div className="mt-4 pt-2 border-t border-dashed border-gray-400 text-left">
                 <p className="text-[10px] font-bold uppercase">Terms & Conditions:</p>
                 <ul className="text-[9px] list-decimal pl-3 mt-1 leading-tight text-gray-800">
                   <li>বিক্রিত পণ্য ফেরত নেওয়া হয় না।</li>
                   <li>ফিজিক্যাল ড্যামেজ বা পোড়া পণ্যের কোনো ওয়ারেন্টি নেই।</li>
                   <li>ওয়ারেন্টি ক্লেইম করার জন্য অবশ্যই মেমো সাথে আনতে হবে।</li>
                 </ul>
               </div>

               <div className="text-center mt-4">
                 <p className="text-[10px] font-bold">Thank you for your business!</p>
                 <p className="text-[8px] text-gray-500 mt-1">Generated by PK TECH</p>
               </div>
              </div>
            </div>
          </>
